...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['bookpkg'])) {
    ...
    $attire_id = $_POST['selected_attire'];
    $dais_id = $_POST['selected_dais'];
    ...
    $insert_rental_query = "INSERT INTO package_bookings (cust_id, event_date, event_loc, slot_id, pkg_id, pax, total_payment, deposit_status, payment_bal, full_payment_date, groom_name, bride_name, promo_code, attire_id, dais_id)
                            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    ...
    mysqli_stmt_bind_param($stmt, "issiiididssssii", $_SESSION['cust_id'], $event_date, $event_location, $slot_id, $pkg_id, $pax, $subtotal_after_discount, $deposit_status, $payment_bal, $full_payment_date, $groom_name, $bride_name, $promo_code, $attire_id, $dais_id);

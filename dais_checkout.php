...
if (isset($_POST['apply_promo'])) {
    ...
    WHERE promo_code = ? AND promo_status = 'Ongoing' AND ctg_name='dais' LIMIT 1";
...
if (isset($_GET['dais_id'])) {
    ...
    if ($dais) {
        $normal_price = $dais['normal_price'];
        $deposit = $dais['deposit'];
            ...
            <div class="upper">
                <div class="container">
                    <div class="row mt-n9 pb-4 p-3 mx-sm-0 mx-1 position-relative">
                                ...
                                <div class="row">
                                    ...
                                    <div class="card shadow-lg">
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <img src="admin/uploads/<?= $dais['image'] ?>" alt="Rounded image" class="avatar avatar-lg">
                                                </div>
                                                <div class="col-md-4">
                                                    <h2 class="h6"><?= $dais['name'] ?></h2>
                                                    <small class="d-block opacity-8"><?= $dais['dais_size'] ?> </small>
                                                </div>
                                            ...
                                            <div class="row  align-items-center">
                                                <div class="col-md-4">
                                                    <span class="h6 opacity-8 mr-3">Deposit</span>
                                                </div>
                                                <div class="col-md-8 text-end">
                        ...
                        <div class="col-lg-8">
                            <div class="card shadow-lg">
                                <form action='rent_dais.php?dais_id=<?= $id ?>' method="POST">
                                        ...
                                        <div class="tab-content tab-space">
                                            <div id="link1" class="tab-pane active">
                                                ...
                                                <div class="d-flex justify-content-end align-items-center">
                                                    <a class="btn btn-outline-warning btn-sm me-2" href="dais.php"><span class="fas fa-angle-left "></span> Cancel</a>

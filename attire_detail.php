...
if (isset($_POST['check'])) {
    ...
    mysqli_stmt_bind_param($stmt, "iss", $_GET['attire_id'], $date, $date);
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="lead mt-2">
                                        <p>
                                            ...
                                            <a class="text-white" href="attire.php"><?= $page_title ?> / </a>
                                            <a class="text-white" href="#attire_detail"><?= $attire['name'] ?></a>
                                        </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-xl-5 col-lg-6 text-center">
                                    <img class="w-100 border-radius-lg shadow-lg mx-auto" src="admin/uploads/<?= $attire['image'] ?>" alt="image">
                                </div>
                                <div class="col-lg-5 mx-auto">
                                    <h2 class="mt-lg-0 mt-4 text-gradient text-warning"><?= $attire['name'] ?></h2>
                                    <!-- <div class="rating">
                                    ...
                                    <h4>RM<?= $attire['normal_price'] ?></h4>
                                    <br>
                                    <h6 class="mt-4">Description</h6>
                                    <p><?= $attire['attire_desc'] ?></p>
                                    <br>
                                    <h6 class="text-dark mt-4">Accessories:</h6>
                                    <ul>
                                        <?php
                                        // Explode the concatenated accessories into an array
                                        $accessories = explode(', ', $attire['accessories']);
                                    ...
                                    <form method="POST">
                                        ...
                                        if ($message == 'Available') {
                                            ...
                                            $checkout_link = "attire_checkout.php?attire_id={$attire['attire_id']}&date={$date}";
                                        ?>

        ...
        <div class="row">
                    ...
                    <div class="container">
                        <form method="GET" action="">
                            ...
                            <div class="mt-3 mb-3">
                                ...
                                <?php
                                $category = getCategory("bridal_attire");
            ...
            <div class="col-lg-9">
                <div class="row">
                    ...
                    $query = "SELECT * FROM bridal_attire";
                    $params = [];
                    $types = "";
                    ...
                    if ($selected_date) {
                        ...
                        $query .= " attire_id NOT IN (SELECT item_id FROM rentals WHERE rental_type = 'attire' AND (

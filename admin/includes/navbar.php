...
<nav class="navbar navbar-main navbar-expand-lg mx-5 px-0 shadow-none rounded " id="navbarBlur" navbar-scroll="true">
  <div class="container-fluid py-1 px-2 ">
    <nav aria-label="breadcrumb">
      ...
      <h6 class="font-weight-bold mb-0"><?php
                                        if (isset($page_title)) {
                                          echo "$page_title";
                                        }
                                        ?></h6>
    ...
    <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
      ...
      <ul class="navbar-nav  justify-content-end">
        ...
        <!-- <li class="nav-item dropdown pe-2 d-flex align-items-center"> -->
          <!-- <a href="quotation.php" class="nav-link text-body p-0" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-expanded="false">
        ...
        <li class="nav-item ps-2 d-flex align-items-center">
          <a href="admin_logout.php" class="nav-link text-body p-0" data-bs-toggle="tooltip" data-bs-title="Logout">
            <span class="me-2">
              <?php
